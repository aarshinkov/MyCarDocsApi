package bg.forcar.api.exceptions.handlers;

import bg.forcar.api.exceptions.MCDException;
import bg.forcar.api.exceptions.AuthException;
import bg.forcar.api.exceptions.responses.AuthenticationErrorResponse;
import bg.forcar.api.exceptions.responses.MCDErrorResponse;
import bg.forcar.api.exceptions.responses.GlobalErrorResponse;
